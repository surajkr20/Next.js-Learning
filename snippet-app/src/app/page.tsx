...
/** making dynamic route - time-based caching
 *    export const dyanmic = "force-dynamic"; // or
  ...
  return (
    <div className="w-full px-20">
      ...
      {snippets.map((snippet) => (
        <div
          key={snippet.id}
          className="flex justify-between mt-3 border-white items-center bg-zinc-700 rounded-md p-3 font-semibold"
        >
